...
#sudo pip3 install scipy tensorflow pandas pyttsx3 SpeechRecognition pyaudio numpy pyyaml requests
#printf "\n\n\n"
...
cd rasa-docker-arm
cp ~/MamaSaraV1/MamaSaraV1_PocketSphinx/rasa_docker/Makefile .
cp ~/MamaSaraV1/MamaSaraV1_PocketSphinx/rasa_docker/build_docker.sh scripts/
cp ~/MamaSaraV1/MamaSaraV1_PocketSphinx/rasa_docker/rasa-1.10.16-arm.patch patches/
cp ~/MamaSaraV1/MamaSaraV1_PocketSphinx/rasa_docker/docker-compose.yml .
make docker
